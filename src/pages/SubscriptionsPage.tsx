  ...
  return (
    <div className="space-y-8">
      <motion.div
        ...
        className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 rounded-2xl p-8 text-white"
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-300 text-lg">Manage your Pro plan subscribers</p>
          </div>
        </div>
      </motion.div>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-emerald-50 to-emerald-100/50">
            <CardContent className="p-8">
              <div className="flex items-center justify-between">
                ...
                <div className="h-16 w-16 bg-emerald-500 rounded-2xl flex items-center justify-center shadow-lg">
            ...
            <CardContent className="p-8">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-900">{activeSubscriptions}</p>
      ...
      >
        <Card className="border-0 shadow-xl">
          <CardHeader className="bg-gray-50/50 rounded-t-lg pb-6">
            <CardTitle className="text-2xl font-bold text-gray-900">Pro Plan Subscriptions</CardTitle>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  className="pl-9 h-11 border-gray-200 focus:border-gray-400 focus:ring-2 focus:ring-gray-400/20"
                />
              </div>
